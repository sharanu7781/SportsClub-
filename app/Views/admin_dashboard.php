              ...
              <div class="card ">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <div class="dropdown">
                      <a href="<?=base_url(); ?>#" data-toggle="dropdown" class="btn btn-warning dropdown-toggle">Options</a>
                      <div class="dropdown-menu">
                        <a href="<?=base_url(); ?>#" class="dropdown-item has-icon"><i class="fas fa-eye"></i> View</a>
                        <a href="<?=base_url(); ?>#" class="dropdown-item has-icon"><i class="far fa-edit"></i> Edit</a>
                        <div class="dropdown-divider"></div>
                        <a href="<?=base_url(); ?>#" class="dropdown-item has-icon text-danger"><i class="far fa-trash-alt"></i>
                          Delete</a>
                      </div>
                    </div>
                    <a href="<?=base_url(); ?>#" class="btn btn-primary">View All</a>
                  </div>
                </div>
                <div class="card-body">
                  <div class="row">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tr>
                        ...
                        <td><a href="<?=base_url(); ?>#" class="btn btn-outline-primary">Detail</a></td>
                      </tr>
                      <tr>
                        <td class="p-0 text-center">
                          <div class="custom-checkbox custom-control">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-12 col-xl-6">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="support-ticket media pb-1 mb-3">
                    ...
                    <div class="media-body ml-3">
                      ...
                      <a href="<?=base_url(); ?>javascript:void(0)">Please add advance table</a>
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    ...
                    <div class="media-body ml-3">
                      ...
                      <a href="<?=base_url(); ?>javascript:void(0)">Select item not working</a>
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    ...
                    <div class="media-body ml-3">
                      ...
                      <a href="<?=base_url(); ?>javascript:void(0)">Are you provide template in Angular?</a>
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="<?=base_url(); ?>assets/img/users/user-6.png" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
                      <div class="badge badge-pill badge-info mb-1 float-right">Enhancement</div>
                      <span class="font-weight-bold">#25874</span>
                      <a href="<?=base_url(); ?>javascript:void(0)">About template page load speed</a>
                ...
                <a href="<?=base_url(); ?>javascript:void(0)" class="card-footer card-link text-center small ">View
                  All</a>
              </div>
              <!-- Support tickets -->
            </div>
